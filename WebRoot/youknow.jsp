			...
			<div class="indexWordBox">
				...
				<p>
					您可以通过下表中的任一方式提出问题；您的问题可能在系统中已有答案，因此建议您在提问之前先登录“<a
						href='<html:rewrite action="/question?action=initPopular"/>'>常见问题</a>”和“<a
						href='<html:rewrite action="/question?action=initList" />'>问题检索</a>”页面进行查询。通过“<a
						href='<html:rewrite action="/person?action=initExpert"/>'>专家档案</a>”，可以了解到每个咨询员的信息。
				</p>
				<p>
					...
					<tbody>
						...
						<tr>
							...
							<td>可通过电话方式向咨询员提出问题并即时得到问题答案。可在“<a
								href='<html:rewrite action="/person?action=initExpert"/>'>专家档案</a>”栏目中查看到各个咨询员的电话号码及能解答问题的范围。
							</td>
						</tr>
						<tr>
							...
							<td>可通过E-mail向咨询员提出问题并得到问题答案。可在“<a
								href='<html:rewrite action="/person?action=initExpert"/>'>专家档案</a>”栏目中查看到各个咨询员的E-mail地址及能解答问题的范围。一般情况下，咨询员将在三个工作日内对问题给出答复。
							</td>
						</tr>
					</tbody>
				</table>
