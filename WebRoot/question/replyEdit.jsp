...
<jsp:include page="../top_sub.jsp"></jsp:include>
...
<div id="mainContentPos2">
	...
	<div id="mainContent2">
		<div id="breadroadbox">当前位置：修改回复内容</div>
			...
			<table width="850">
				...
				<c:if
					...
					<html:form action="/reply" method="post">
						<table>
							<html:hidden property="action" value="submitEdit" />
