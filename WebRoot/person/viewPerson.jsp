	...
	<div id="mainContent2">
		<div class="t" style="margin-bottom:0px; border-bottom:0">
			<table cellspacing="0" cellpadding="0" width="100%">
				<tr>
					<th class="h"><strong class="fl w">查看用户资料</strong> &nbsp; <span
		...
		<div class="t t2">
			<table width="100%">
				<tr class="bg2">
					<td style="width:120px; " class="tdbg1">姓名:</td>
					<td>${person.name }</td>
				</tr>
				<tr class="bg4">
					<td style="width:120px; " class="tdbg1">性别:</td>
					<td>${person.sex }</td>
				</tr>
				<tr class="bg2">
					<td style="width:120px; " class="tdbg1">电子邮件:</td>
					<td>${person.email }</td>
				</tr>
				<tr class="bg4">
					<td style="width:120px; " class="tdbg1">注册时间:</td>
					<td><fmt:formatDate value="${person.dateCreated }" type="both" />
					</td>
				</tr>
				<tr class="bg2">
					<td style="width:120px; " class="tdbg1">上次登录时间:</td>
			...
			%>
			<tr class="bg4">
					<td style="width:120px; " class="tdbg1">专家类型:</td>
					<td>
					<% 
			...
			<c:if test="${personInfo.isAdmin() }">
				<c:if test="${person.isExpert() }">
					<table class="inputTableStyle" id="d-type">
						...
						<tr>
							<td><input type="button" value="提交修改"
